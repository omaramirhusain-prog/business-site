  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-6 pt-28 md:grid-cols-2 md:pt-0">
        ...
        <div className="relative z-0 h-[320px] w-full sm:h-[460px] md:h-[560px]">
          <Scene3D />
        </div>
      </div>

      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-xs uppercase tracking-widest text-zinc-600">
        scroll
      </div>
    </section>
  );
